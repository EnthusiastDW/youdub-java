...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    settings: {
      ...
      separateFfmpegNote: "FFmpeg simple filter: vocals only (no BGM — frequency-based BGM is noisy). Use Onnx or Demucs for full separation with BGM.",
      ...
      path: "Path",
      baseLmModel: "BaseLM model",
      acousticModel: "Acoustic model",
      cfgValue: "CFG scale",
      timesteps: "CFM timesteps",
      seed: "Seed",
  ...
  zh: {
    ...
    settings: {
      ...
      separateFfmpegNote: "FFmpeg 简单滤波：仅提取人声（不含背景音乐——频率滤波产生的 BGM 噪声大）。如需带 BGM 的完整分离，请选择 ONNX 或 Demucs。",
      ...
      serviceUrl: "服务地址",
      path: "路径",
      baseLmModel: "BaseLM 模型",
      acousticModel: "Acoustic 模型",
      cfgValue: "CFG 强度",
      timesteps: "CFM 采样步数",
      seed: "随机种子",
